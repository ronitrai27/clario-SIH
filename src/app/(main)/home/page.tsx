    ...
    <div className="h-full  bg-gray-50 py-6 pl-0 pr-4 w-full overflow-hidden">
      <div className="flex h-full justify-between overflow-hidden ">
        ...
        <div className="w-[75%]">
          ...
          {/* MENTORS !! */}
          <div className="max-w-[840px] mx-auto  p-2 mt-10  overflow-hidden">
            ...
            {mentorLoading || loading ? (
              <div className="flex space-x-6 overflow-x-auto px-2 scrollbar-hide">
                {Array.from({ length: 6 }).map((_, i) => (
                  <Skeleton
                    key={i}
                    className="h-[300px] w-[250px] rounded-2xl flex-shrink-0"
                  />
                ))}
              </div>
            ) : (
              <div className="w-full overflow-hidden">
                <div className="flex space-x-6 overflow-x-auto px-2 scrollbar-hide">
                  {mentors.map((m) => (
                    <Card
                      key={m.id}
                      className="relative group max-w-[300px] max-h-[320px] flex-shrink-0 rounded-2xl shadow-md bg-white p-0 overflow-hidden hover:-translate-y-0.5 duration-200"
                    >
        ...
        {/* --------------Right side--------------- */}
        <div className="w-[25%]  flex flex-col gap-10  items-center h-full">
          <HomeCalendar />
          {/* Messages Container */}
          <div className="w-full h-[460px] bg-white rounded-xl shadow px-2 py-4">
