      ...
      <div className="flex h-full justify-between overflow-hidden ">
        ...
        <div className="w-[75%] px-2">
          ...
          {loading ? (
            ...
            <div className="mt-6 max-w-[800px]  mx-auto flex justify-between items-center">
          ...
          {/* AI SUGGESSTIONS  */}
          <div className="border border-dashed border-blue-500 bg-blue-50 rounded-md  pt-4 px-4 w-[820px] mx-auto mt-14">
